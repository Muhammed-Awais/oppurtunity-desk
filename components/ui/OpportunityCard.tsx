        ...
        <div className="card-core flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="p-6 md:p-8 flex flex-col h-full">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <span className="text-xs font-medium text-zinc-400 uppercase tracking-widest text-right line-clamp-1 ml-2">
            ...
            <div className="mt-auto flex items-end justify-between gap-4 pt-5 border-t border-zinc-100">
              <div className="flex flex-col gap-2">
                <span className="flex items-center gap-1.5 text-xs text-zinc-500 font-medium">
                  <MapPin size={14} weight="duotone" className="text-zinc-400 shrink-0" />
                  <span className="truncate">{opportunity.location}</span>
                </span>
                <span className="flex items-center gap-1.5 text-xs text-zinc-500 font-medium">
                  <Calendar size={14} weight="duotone" className="text-zinc-400 shrink-0" />
                  <span className="text-zinc-400">Deadline:</span> {opportunity.deadline}
                </span>
              </div>
              <span className="flex items-center justify-center w-10 h-10 shrink-0 rounded-full bg-zinc-900 text-white transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:bg-accent group-hover:scale-110 active:scale-95 shadow-sm">
